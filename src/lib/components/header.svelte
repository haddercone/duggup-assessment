<script lang="ts">
  ...
  const name = clipText("Krishna Kiran", 15);
</script>
    ...
    <DropdownMenu.Root>
      <DropdownMenu.Trigger>
        <div class="flex gap-4 items-center">
          <img
            src="./profile.jpeg"
            class="w-[46px] h-[46px] rounded-full border-[0.5px] border-[#4D4D4D]"
            alt="user"
          />
          <span
            class="font-[500] text-[20px] text-[#4D4D4D] lg:block max-w-60 text-nowrap"
            >{name}</span
          >
  ...
  <div class="md:hidden flex items-center gap-4">
    ...
    <DropdownMenu.Root>
      <DropdownMenu.Trigger class="mr-2">
        <img
          src="./profile.jpeg"
          class="min-w-[46px] min-h-min h-[46px] rounded-full border-[0.5px] border-[#4D4D4D]"
          alt="user"
        />
        <!-- <img src="./arrow-head-down.svg" alt="" srcset=""> -->
      </DropdownMenu.Trigger>
